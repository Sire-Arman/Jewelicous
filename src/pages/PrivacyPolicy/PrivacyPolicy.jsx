  ...
  return (
    <div className="privacy-policy">
      ...
      <div className="privacy-policy-content">
        <p>
          This privacy policy sets out how{/*Neel Jewels*/} uses and protects
          any information that you give{/*Neel Jewels*/} when you use this
          website. {/*Neel Jewels*/} is committed to ensuring that your privacy
          ...
          statement.
          {/*Neel Jewels*/} may change this policy from time to time by updating
        ...
        <p>
          ...
          writing to or emailing us at support <b>armansid6783@gmail.com</b>
        </p>
        <p>
